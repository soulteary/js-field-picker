...
window.FieldPicker=function(b,d){function f(){g.Options&&g.Options.updater&&"function"===typeof g.Options.updater&&g.Options.updater(g.Selected,g)}function k(a){var e=c.makeIterator(a).next().value,h=e.cname;e=e.code;a=a.every(function(r){return r.checked});return'\n      <div class="field-picker-row-container">\n        <div class="field-picker-title clickable">'+h+'</div>\n        <div class="field-picker-checkbox-container">\n          <label for="field-'+e+'" class="field-picker-checkbox-label field-picker-checkbox-group">\n            <input id="field-'+
...
"expand")}):a.forEach(function(h){w(h)}))}})}var g={ComponentId:"",Options:{},Selected:[],Fields:{RootField:{},MainField:[],States:{}},Skips:[],TriggerEachClick:!1,GetSelected:function(){return this.Selected},Show:function(){var a=document.getElementById(g.ComponentId);a.className=a.className.replace(/\s?hide/g,"")},Hide:function(){var a=document.getElementById(g.ComponentId);a.className+=" hide";f()}};return function(a,e){var h="field-picker-"+Math.random().toString(36).slice(-6);g.ComponentId=h;
g.Options=e;var r=e.data,n=e.preselected,p=e.skips;e=e.triggerEachClick;g.Fields.RootField=[r[0]];g.Fields.MainField=r.slice(1);g.TriggerEachClick=e||!1;r=r.map(function(l){return l.children&&l.children.length?l.children.filter(function(u){return u.checked}):!1}).filter(function(l){return l}).reduce(function(l,u){return l.concat(u)},[]).map(function(l){return l.code});g.Selected=r;n&&("string"===typeof n?"all"===n?g.Selected=g.Fields.MainField.map(function(l){return l.code}).concat(g.Fields.RootField.map(function(l){return l.code})):
g.Selected.includes(n)||(g.Selected=g.Selected.concat(n)):n&&n.length&&n.forEach(function(l){g.Selected.includes(l)||(g.Selected=g.Selected.concat(l))}));p&&("string"===typeof p?g.Skips=[p]:p.length&&(g.Skips=p));t(a,h);E();F();A();v();f();return g}(b,d)};}).call(this);
