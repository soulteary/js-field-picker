...
n+"\n      </div>\n    "}function q(a){return a&&a.length?'\n      <div class="field-picker-children-group field-picker-groups hide">\n        '+a.map(function(e){return m(e)}).join("")+"\n      </div>\n    ":""}function t(a,e){e='\n      <div id="'+e+'" class="field-picker-container no-select">\n        <div class="field-picker-item-group">\n          '+k(h.Fields.RootField)+'\n          <div class="field-picker-children-group field-picker-top-groups">\n            '+h.Fields.MainField.map(function(g){return m(g)}).join("")+
"\n          </div>\n        </div>\n      </div>\n    ";document.querySelector(a).innerHTML=e}function v(){var a=document.getElementById(h.ComponentId);a=Array.from(a.querySelectorAll(".field-picker-checkbox-label input[type=checkbox]"));a.forEach(function(e){x(e)});h.Selected=a.map(function(e){return e.checked?e.value:null}).filter(function(e){return e});h.TriggerEachClick&&f()}function A(){document.getElementById(h.ComponentId).addEventListener("click",function(a){if(a=a.target.closest(".field-picker-checkbox-label input[type=checkbox]"))"field-all"==
a.value?y(a,!0):y(a),v()},!1)}function x(a){var e=document.getElementById(h.ComponentId),g=e.querySelectorAll(".field-picker-top-groups > .field-picker-item-group"),r=a.closest(".field-picker-item-group");Array.from(g).forEach(function(p){if(p==r){var l=p.querySelector(".field-checkbox-item"),u=Array.from(p.querySelectorAll(".field-picker-groups input[type=checkbox]"));p=Array.from(p.querySelectorAll(".field-picker-groups input[type=checkbox]:checked"));var C=u.filter(function(B){return h.Skips.includes(B.value)}).length;
...
var n=e.closest(".field-picker-checkbox-group").querySelector(".field-checkbox-item");e.checked=!1;a.length==g.length?(n.classList.remove("is-indeterminate"),n.classList.add("checked"),e.checked=!0):1<a.length?(n.classList.remove("checked"),n.classList.add("is-indeterminate")):(n.classList.remove("checked"),n.classList.remove("is-indeterminate"))}function y(a){var e=a.checked,g=a.closest(".field-picker-item-group").querySelector(".field-picker-children-group");D(g,e);x(a)}function D(a,e){a&&a.querySelectorAll("input[type=checkbox]").forEach(function(g){h.Skips.includes(g.value)||
(g.checked=e)})}function w(a,e){if(a){var g=a.closest(".field-picker-item-group").querySelector(".field-picker-children-group");"string"===typeof e?"expand"===e?(g.classList.remove("hide"),a.textContent="-"):"collapse"===e&&(g.classList.add("hide"),a.textContent="+"):g.classList.contains("hide")?(g.classList.remove("hide"),a.textContent="-"):(g.classList.add("hide"),a.textContent="+")}}function E(){document.getElementById(h.ComponentId).addEventListener("click",function(a){a=a.target.closest(".field-picker-sign");
w(a)})}function F(){document.getElementById(h.ComponentId).addEventListener("click",function(a){if(a.target.closest(".field-picker-title")){var e=a.target.closest(".field-picker-menu-group");e?(a=e.querySelector(".field-picker-sign"))&&w(a):(a=a.target.closest(".field-picker-item-group").querySelector(".field-picker-children-group").querySelectorAll(".field-picker-sign"),Array.from(a).map(function(g){return"-"==g.innerHTML.trim()}).filter(function(g){return g}).length!==a.length?a.forEach(function(g){w(g,
"expand")}):a.forEach(function(g){w(g)}))}})}var h={ComponentId:"",Options:{},Selected:[],Fields:{RootField:{},MainField:[],States:{}},Skips:[],TriggerEachClick:!1,GetSelected:function(){return this.Selected},Show:function(){var a=document.getElementById(h.ComponentId);a.className=a.className.replace(/\s?hide/g,"")},Hide:function(){var a=document.getElementById(h.ComponentId);a.className+=" hide";f()}};return function(a,e){var g="field-picker-"+Math.random().toString(36).slice(-6);h.ComponentId=g;
h.Options=e;var r=e.data,n=e.preselected,p=e.skips;e=e.triggerEachClick;h.Fields.RootField=[r[0]];h.Fields.MainField=r.slice(1);h.TriggerEachClick=e||!1;r=r.map(function(l){return l.children&&l.children.length?l.children.filter(function(u){return u.checked}):!1}).filter(function(l){return l}).reduce(function(l,u){return l.concat(u)},[]).map(function(l){return l.code});h.Selected=r;n&&("string"===typeof n?"all"===n?h.Selected=h.Fields.MainField.map(function(l){return l.code}).concat(h.Fields.RootField.map(function(l){return l.code})):
h.Selected.includes(n)||(h.Selected=h.Selected.concat(n)):n&&n.length&&n.forEach(function(l){h.Selected.includes(l)||(h.Selected=h.Selected.concat(l))}));p&&("string"===typeof p?h.Skips=[p]:p.length&&(h.Skips=p));t(a,g);E();F();A();v();f();return h}(b,d)};}).call(this);
